      ...
      <div className='h-full'>
        ...
        <aside className={`bg-white shadow-md h-full ${isSidebarOpen ? 'w-64' : 'w-20'} lg:w-64 lg:h-full`}>
          <nav className="flex flex-col mt-6 px-2 space-y-2 text-gray-400 text-sm ">
            ...
            <div className={`inline-flex gap-2 block py-2 h-full lg:h-full px-4 rounded ${isActive('/dashboard/attendance') ? 'bg-blue-50 text-blue-600' : 'text-gray-700'}`}>
              <LuFileSpreadsheet className='text-2xl' />
              {isSidebarOpen && <a href={"/dashboard/attendance"} className="text-lg">Attendance Sheet</a>}
            </div>
            ...
            <div className={`inline-flex block py-2 px-4 rounded gap-2 ${isActive('/dashboard/student') ? 'bg-blue-50 text-blue-600' : 'text-gray-700'} hover:bg-blue-50 hover:text-blue-600`}>
              ...
              {isSidebarOpen && <a href={"/dashboard/student"} className="text-lg">Student</a>}
            </div>
